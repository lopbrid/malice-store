...
def test_email_render(request):
    """Test email configuration and rendering"""
    from django.conf import settings
    import os

    # Collect debug info - FIXED: Removed PLUNK_SMTP_PASSWORD reference
    debug_info = {
        ...
        'RESEND_API_KEY set': bool(settings.RESEND_API_KEY),
    ...
    try:
        sent = send_mail(
            'Test from Django',
            f'This is a test from your Django deployment.\n\nDebug info:\n{debug_info}',

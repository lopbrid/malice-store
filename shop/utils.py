"""
Utility functions for MALICE E-Commerce
Includes: OTP sending, Payment processing, Shipping calculations
"""
...
# ============================================
# OTP UTILITIES - RESEND SMTP
# ============================================

def send_email_otp(user, email):
    """Send OTP via Resend SMTP using Django's send_mail"""
...
"""
        ...
        # Send email via Django's send_mail (uses Resend SMTP)
        sent = send_mail(
